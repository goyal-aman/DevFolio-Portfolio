...
export default function Profile() {
  ...
  function setProfileFunction(array) {
    array = openSource.user;
    console.log("THIS IS SETREPO", array);
    console.log("END");
    setrepo(array);
  }
      ...
      const getProfileData = () => {
        fetch("/profile.json")
          ...
          .then(response => {
            ...
            setProfileFunction(openSource.data.user);
          })
  ...
  if ( true) {
    console.log(prof.id, 'THIS IS FOR DEBUG');
    return (
